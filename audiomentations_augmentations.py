from audiomentations import Compose, AddGaussianNoise, PitchShift, HighPassFilter, ApplyImpulseResponse
...
augment= Compose([
    ...
    ApplyImpulseResponse(ir_path="impulse_responses/Underpasses", p=1.0)
])
